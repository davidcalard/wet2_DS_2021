...
StatusType CarDealershipManager::CDMAddAgency(void *DS){
    try {
...
StatusType CarDealershipManager::CDMSellCar(void *DS, int agencyID, int typeID, int k){
    try {
...
StatusType CarDealershipManager::CDMUniteAgencies(void *DS, int agencyID1, int agencyID2){
    try {
...
StatusType CarDealershipManager::CDMGetIthSoldType(void *DS, int agencyID, int i, int* res){
    try {
